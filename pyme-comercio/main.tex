...
\newfontfamily\coverfont{TeXGyreTermes}
...
\usepackage{enumitem}
\usepackage{caption}
% Formato APA 7 para figuras: número en negrita, título en cursiva y nota de procedencia.
% Según APA 7/UPC, la nota debe precisar si la figura es de elaboración propia,
